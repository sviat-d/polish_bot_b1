/**
 * Polish B1 Exam Prep — Tasks Database
 */
...
module.exports = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "B",
        text: "nowego telefonu"
      },
      {
        label: "C",
        text: "nowym telefonem"
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Się bardzo cieszę, że przyjechałeś."
      },
      {
        label: "B",
        text: "Bardzo się cieszę, że przyjechałeś."
      },
      {
        label: "C",
        text: "Cieszę bardzo się, że przyjechałeś."
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Kiedy się obudziłem, było już późno."
      },
      {
        label: "B",
        text: "Kiedy obudziłem się, było już późno."
      },
      {
        label: "C",
        text: "Się kiedy obudziłem, było już późno."
      },
      {
        label: "D",
        text: "Kiedy obudziłem, się było już późno."
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "B",
        text: "Jeśli wyjdziesz"
      },
      {
        label: "C",
        text: "Kiedy wyszedłeś"
      },
      {
        label: "D",
        text: "Że wyszedłeś"
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "dwa tysiące dziesiątego"
      },
      {
        label: "B",
        text: "dwutysięcznego dziesiątego"
      },
      {
        label: "C",
        text: "dwa tysiące dziesiąty"
      },
      {
        label: "D",
        text: "dwutysięcznym dziesiątym"
      }
    ],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "tysiąc dwieście trzydzieści pięć"
      },
      {
        label: "B",
        text: "tysiąca dwustu trzydziestu pięciu"
      },
      {
        label: "C",
        text: "tysiącem dwustu trzydziestu pięciu"
      },
      {
        label: "D",
        text: "tysiące dwieście trzydzieści pięć"
      }
    ],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Złodziej został zatrzymany przez policję."
      },
      {
        label: "B",
        text: "Złodziej był zatrzymany przez policję."
      },
      {
        label: "C",
        text: "Złodziej zatrzymał się przez policję."
      },
      {
        label: "D",
        text: "Złodzieja zatrzymała policja."
      }
    ],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "jutro pójdzie do lekarza"
      },
      {
        label: "B",
        text: "następnego dnia pójdzie do lekarza"
      },
      {
        label: "C",
        text: "jutro poszedł do lekarza"
      },
      {
        label: "D",
        text: "następnego dnia poszedłby do lekarza"
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Trzeba to zrobić."
      },
      {
        label: "B",
        text: "Trzeba ci to zrobić."
      },
      {
        label: "C",
        text: "Trzeba, żebyś to zrobił."
      },
      {
        label: "D",
        text: "Trzeba tobie to zrobić."
      }
    ],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Wszyscy nie przyszli na spotkanie."
      },
      {
        label: "B",
        text: "Nikt nie przyszedł na spotkanie."
      },
      {
        label: "C",
        text: "Nie wszyscy przyszli na spotkanie."
      },
      {
        label: "D",
        text: "Żaden nie przyszedł na spotkanie."
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Jan jest najwyższy z Piotra."
      },
      {
        label: "B",
        text: "Jan jest najwyższym z nich dwóch."
      },
      {
        label: "C",
        text: "Jan jest wyższy najwyżej."
      },
      {
        label: "D",
        text: "Jan jest najwyższy niż Piotr."
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Gdyby była ładna pogoda, poszlibyśmy na spacer."
      },
      {
        label: "B",
        text: "Jeśliby była ładna pogoda, poszlibyśmy na spacer."
      },
      {
        label: "C",
        text: "Gdyby będzie ładna pogoda, pójdziemy na spacer."
      },
      {
        label: "D",
        text: "Jak była ładna pogoda, poszliśmy na spacer."
      }
    ],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Podmiot jest ten sam: \"Chcę ci pomóc.\""
      },
      {
        label: "B",
        text: "Podmiot jest inny: \"Chcę pomóc ci.\""
      },
      {
        label: "C",
        text: "Nie można przekształcić na bezokolicznik."
      },
      {
        label: "D",
        text: "Podmiot jest ten sam: \"Chcę, żebym ci pomógł.\""
      }
    ],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Po skończeniu pracy zadzwonię do ciebie."
      },
      {
        label: "B",
        text: "Po skończyć pracę zadzwonię do ciebie."
      },
      {
        label: "C",
        text: "Po tym skończę pracę, zadzwonię do ciebie."
      },
      {
        label: "D",
        text: "Po pracy skończonej zadzwonię do ciebie."
      }
    ],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Ten film ma dużo interesowania."
      },
      {
        label: "B",
        text: "Ten film budzi duże zainteresowanie."
      },
      {
        label: "C",
        text: "Ten film jest z interesem."
      },
      {
        label: "D",
        text: "Ten film interesuje bardzo."
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Nie wiem, on lubi kawę?"
      },
      {
        label: "B",
        text: "Nie wiem, czy on lubi kawę."
      },
      {
        label: "C",
        text: "Nie wiem, że on lubi kawę."
      },
      {
        label: "D",
        text: "Nie wiem, lub on lubi kawę."
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Da się to naprawić."
      },
      {
        label: "B",
        text: "To da się naprawić."
      },
      {
        label: "C",
        text: "To daje się naprawić."
      },
      {
        label: "D",
        text: "To się da naprawić."
      }
    ],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Zostaliśmy w domu, dlatego padał deszcz."
      },
      {
        label: "B",
        text: "Padał deszcz, więc zostaliśmy w domu."
      },
      {
        label: "C",
        text: "Padał deszcz, bo zostaliśmy w domu."
      },
      {
        label: "D",
        text: "Padał deszcz, żeby zostać w domu."
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Mimo był zmęczony, poszedł na trening."
      },
      {
        label: "B",
        text: "Mimo to zmęczony, poszedł na trening."
      },
      {
        label: "C",
        text: "Mimo tego był zmęczony, poszedł na trening."
      },
      {
        label: "D",
        text: "Mimo że był zmęczony, poszedł na trening."
      }
    ],
    correctAnswer: "D",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Sekretarka została wysłana listem."
      },
      {
        label: "B",
        text: "List wysłał sekretarkę."
      },
      {
        label: "C",
        text: "Sekretarka wysłała list."
      },
      {
        label: "D",
        text: "Sekretarka wysyłała list."
      }
    ],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Przed wyszedłem sprawdziłem pogodę."
      },
      {
        label: "B",
        text: "Przed wyjściem sprawdziłem pogodę."
      },
      {
        label: "C",
        text: "Przed tym wyszedłem, sprawdziłem pogodę."
      },
      {
        label: "D",
        text: "Przed wychodzeniem sprawdziłem pogodę."
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "On odpowiedział szybko."
      },
      {
        label: "B",
        text: "On odpowiedział szybki."
      },
      {
        label: "C",
        text: "On szybko był odpowiedź."
      },
      {
        label: "D",
        text: "On odpowiadał szybką."
      }
    ],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Mówi zarówno po polsku, oraz po angielsku."
      },
      {
        label: "B",
        text: "Mówi zarówno po polsku, ale i po angielsku."
      },
      {
        label: "C",
        text: "Mówi zarówno po polsku, jak i po angielsku."
      },
      {
        label: "D",
        text: "Mówi zarówno po polsku, a także po angielsku."
      }
    ],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Dni są najkrótsze."
      },
      {
        label: "B",
        text: "Dni stają się krótkie."
      },
      {
        label: "C",
        text: "Dni są bardziej krótsze."
      },
      {
        label: "D",
        text: "Dni są krótsze i krótsze."
      }
    ],
    correctAnswer: "D",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Mój rower został ukradziony."
      },
      {
        label: "B",
        text: "Ukradziono mój rower."
      },
      {
        label: "C",
        text: "Mój rower ukradł się."
      },
      {
        label: "D",
        text: "Mój rower się ukradł."
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Jest zbyt zmęczony, żeby pracować."
      },
      {
        label: "B",
        text: "Jest zbyt zmęczony, żeby nie pracować."
      },
      {
        label: "C",
        text: "Jest za zmęczony, że pracować."
      },
      {
        label: "D",
        text: "Jest zbyt zmęczony, aby nie pracować."
      }
    ],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "C",
        text: "bardziej interesująca"
      },
      {
        label: "D",
        text: "więcej interesująca"
      }
    ],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "C",
        text: "coraz najwyższe"
      },
      {
        label: "D",
        text: "coraz najbardziej wysokie"
      }
    ],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Jest mądrzejszy niż brat."
      },
      {
        label: "B",
        text: "Jest mądrzejszy od brata."
      },
      {
        label: "C",
        text: "Jest bardziej mądry niż brat."
      },
      {
        label: "D",
        text: "Jest bardziej mądry od brata."
      }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Ta sukienka jest bardziej czerwona."
      },
      {
        label: "B",
        text: "Ten kształt jest bardziej okrągły."
      },
      {
        label: "C",
        text: "Ta odpowiedź jest bardziej poprawna."
      },
      {
        label: "D",
        text: "Ten metal jest bardziej żelazny."
      }
    ],
    correctAnswer: "D",
  ...
  {
    id: "B2_LICZEBNIKI_005",
    source: "pdf",
    question: "Na konferencji wystąpiło _______ prelegentów.",
    options: [
      {
        label: "A",
        text: "dwadzieścia trzy"
      },
      {
        label: "B",
        text: "dwudziestu trzech"
      },
      {
        label: "C",
        text: "dwadzieścia trzech"
      },
      {
        label: "D",
        text: "dwudziestu trzy"
      }
    ],
    correctAnswer: "B",
  ...
  {
    id: "B1_LICZEBNIKI_039",
    source: "pdf",
    question: "Urodziłem się w _______ roku.",
    options: [
      {
        label: "A",
        text: "tysiąc dziewięćset dziewięćdziesiąty"
      },
      {
        label: "B",
        text: "tysiąc dziewięćset dziewięćdziesiątym"
      },
      {
        label: "C",
        text: "tysiąc dziewięćset dziewięćdziesiąt"
      },
      {
        label: "D",
        text: "tysiącu dziewięćset dziewięćdziesiątym"
      }
    ],
    correctAnswer: "D",
  ...
  {
    id: "B1_LICZEBNIKI_041",
    source: "pdf",
    question: "Pociąg odjeżdża o _______.",
    options: [
      {
        label: "A",
        text: "piętnaście trzydzieści"
      },
      {
        label: "B",
        text: "piętnastej trzydzieści"
      },
      {
        label: "C",
        text: "piętnaście i trzydzieści"
      },
      {
        label: "D",
        text: "godzina piętnasta trzydzieści"
      }
    ],
    correctAnswer: "B",
  ...
  {
    id: "B1_LICZEBNIKI_042",
    source: "pdf",
    question: "Moja babcia ma _______ lat.",
    options: [
      {
        label: "A",
        text: "siedemdziesiąt pięć"
      },
      {
        label: "B",
        text: "siedemdziesiąciu pięciu"
      },
      {
        label: "C",
        text: "siedemdziesiąt piąty"
      },
      {
        label: "D",
        text: "siedemdziesięciopięcioletni"
      }
    ],
    correctAnswer: "A",
  ...
  {
    id: "B1_LICZEBNIKI_043",
    source: "pdf",
    question: "Kupiłem tę książkę za _______ złotych.",
    options: [
      {
        label: "A",
        text: "czterdzieści dwa"
      },
      {
        label: "B",
        text: "czterdziestu dwóch"
      },
      {
        label: "C",
        text: "czterdzieści dwóch"
      },
      {
        label: "D",
        text: "czterdzieści druga"
      }
    ],
    correctAnswer: "A",
  ...
  {
    id: "B1_LICZEBNIKI_044",
    source: "pdf",
    question: "_______ ankietowanych popiera tę decyzję.",
    options: [
      {
        label: "A",
        text: "Sześćdziesięciu procent"
      },
      {
        label: "B",
        text: "Sześćdziesiąt procentów"
      },
      {
        label: "C",
        text: "Sześćdziesiąt procent"
      },
      {
        label: "D",
        text: "Sześćdziesiąty procent"
      }
    ],
    correctAnswer: "C",
